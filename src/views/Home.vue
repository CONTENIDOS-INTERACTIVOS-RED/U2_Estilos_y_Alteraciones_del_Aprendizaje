          ...
          .row.g-0
            ...
            .col-xl-6.info-section
              .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
                ...
                p.descripcion.mb-4 Los trastornos del neurodesarrollo afectan el desarrollo del sistema nervioso y pueden impactar habilidades cognitivas, motoras, del lenguaje y del comportamiento. Incluyen el trastorno del lenguaje, el TDAH, el TEA y el trastorno del desarrollo intelectual. Pueden tener causas genéticas, prenatales, perinatales o postnatales. Su diagnóstico y tratamiento requieren evaluaciones especializadas y estrategias educativas inclusivas. El TEA, por ejemplo, se manifiesta con dificultades en la interacción social y comportamientos repetitivos. La intervención temprana, terapias conductuales y adaptaciones en el aula son clave para mejorar la calidad de vida de quienes los padecen.
